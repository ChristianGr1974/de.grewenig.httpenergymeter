...
const ElectricMeterDevice = require("./access/ElectricMeterDevice");
...
class HttpEnergyMeterDevice extends Homey.Device {
  ...
  async onInit() {
    ...
    this.log(`HttpEnergyMeterV2Device has been initialized`);

    this.meter = new ElectricMeterDevice(settings, this);
   ...
   */
  async onAdded() {
    this.log("HttpEnergyMeterV2Device has been added");
  }
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    this.log("ElectricMeterDevice settings where changed");
  ...
  async onRenamed(name) {
    this.log("ElectricMeterDevice was renamed");
  }
